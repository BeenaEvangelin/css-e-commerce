...
import classes from "../pages/OtherItemsPage.module.css";
import { AllItems } from "../Components/OtherItems/otherItems";
import { useParams } from "react-router-dom";

const OtherItemsPage = () => {
  const { id } = useParams();
  const currentItem = AllItems[parseInt(id)];
  const { image, title, colors, background, amount } = currentItem;
  return (
